...
Comments are a AfriAnnotate feature that allows communication between reviewers and annotators:
...
![Screenshot of comments](/annotate-assets/img/review/comments.png)
...
![Screenshot of comments](/annotate-assets/img/review/comment_panel.png)
...
![Gif of linking a comment](/annotate-assets/img/review/comment_links.gif)
...
* Linking is not supported for `<Ranker>` or `<Pairwise>` fields. 
...
![Screenshot of comment action menu](/annotate-assets/img/review/comment_actions.png)
...
:::note
Users in the Reviewer or Annotator role must be granted access to view the Data Manager. You can grant access in **Project → Settings**.
:::
## Require comments
...
* **Project → Settings → Annotation → Annotators must leave a comment on skip**
* **Project → Settings → Review → Reviewers must leave a comment on reject**
...
![Screenshot of notifications](/annotate-assets/img/comments-notifications/notifications.png)
...
* If this is the first comment on an annotation, then all users within a project that have the role of Reviewer or higher see the comment in their [notification list](#comment-notifications). 
