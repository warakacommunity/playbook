...
* Use workspaces to simplify project membership administrations. When a user is added as a member to a workspace, they will have access to all projects within that workspace. Their permissions for the project depend on their [user role](/annotate/organization/roles).
...
:::
1. In AfriAnnotate, click the plus icon next to **Workspaces** in the menu on the right:

    ![Screenshot of add button](/annotate-assets/img/click-plus-sign.png)

2. Provide a name for the workspace and, optionally, a color. 
3. Click **Save**. 

You can now begin [creating projects](/annotate/projects/setup) within the workspace. 

:::info[Tip]
You can also create projects by duplicating an existing project from a different workspace. Or, you can update a project's settings in **Project → Settings → General** to move it from one workspace to another.

:::
## Sandbox workspace

Each user has a personal Sandbox workspace that they can use to experiment with project settings and get familiar with AfriAnnotate. Only you can see projects within your sandbox. 
...
Users are not sent notifications when they are added to a workspace. The workspace appears when they log in to AfriAnnotate or refresh their page.

## Workspace permissions

User roles are set at the organization level. For more information, see [User roles and permissions](/annotate/organization/roles).
...
![Screenshot of workspace menu](/annotate-assets/img/project/workspace-edit-modal.png)
...
![Screenshot of workspace menu](/annotate-assets/img/project/workspace-dropdown-menu.png)
...
![Screenshot of archived workspace options](/annotate-assets/img/project/workspace-archive-expand.png)
...
![Screenshot of archived workspace options](/annotate-assets/img/project/workspace-unarchive-menu.png)


## Delete a workspace

You can only delete a workspace if it has no projects. To delete a workspace, first delete its projects (from **Project → Settings → Danger Zone**) or move them to another workspace (via **Project → Settings → General**).
