...
title: "List"
sidebar_label: "List"
description: "Object tag — The `List` tag is used to display a list of similar items like articles, search results, etc. Task data in the `value` parameter should be an array of objects with `id`, `title`, `body`, and `html` fields."
mdx:
  format: md
---
...
| value | string | **yes** | — | Data field containing a JSON with array of objects (id, title, body) to rank |
...
{
  "items": [
     { "id": "blog", "title": "Image 1", "html": "![](http://example.com/1.jpg)" },
     { "id": "mdn", "title": "Image 2", "html": "![](http://example.com/2.jpg)" }
   ]
}
```
