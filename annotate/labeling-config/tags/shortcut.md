...
description: "Control tag — The `Shortcut` tag to define a shortcut that annotators can use to add a predefined object, such as a specific label value, with a hotkey or keyboard shortcut."
mdx:
  format: md
---
...
|---|---|---|---|---|
| value | string | **yes** | — | The value of the shortcut |
| alias | string | no | — | Shortcut alias |
| hotkey | string | no | — | Hotkey |
| background | string | no | `#333333` | Background color in hexadecimal |
