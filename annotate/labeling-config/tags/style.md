...
|---|---|---|---|---|
| `.<className>` | string | **yes** | — | Reference the className specified in the View tag to apply to a section of the labeling configuration. |
| CSS property | string | no | — | CSS property and value to apply. |
