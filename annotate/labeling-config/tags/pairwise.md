---
title: "Pairwise"
sidebar_label: "Pairwise"
description: "Control tag — The `Pairwise` tag is used to compare two different objects and select one item from the list. If you want annotators to compare two objects and determine whether they are similar or not, use the `Choices` tag."
mdx:
  format: md
---
...
| toName | string | **yes** | — | Comma-separated names of the elements you want to compare |
| selectionStyle | string | no | — | Style for the selection |
