...
title: "Video"
sidebar_label: "Video"
description: "Object tag — Video tag plays a simple video file. Use for video annotation tasks such as classification and transcription."
mdx:
  format: md
---
...
| value | string | **yes** | — | URL of the video |
| frameRate | number | no | `24` | video frame rate per second; default is 24; can use task data like `$fps` |
| sync | string | no | — | object name to sync with |
| muted | true,false | no | `false` | muted video |
| height | number | no | `600` | height of the video player |
| timelineHeight | number | no | `64` | height of the timeline with regions |
| defaultPlaybackSpeed | number | no | `1` | default playback speed the player should start with when loaded |
| minPlaybackSpeed | number | no | `1` | minimum allowed playback speed; defaultPlaybackSpeed cannot be set below this value |
