/**
 * Inline SVG icons adapted from Lucide (https://lucide.dev/) — ISC licensed.
 * Stroke-based, 24x24 viewBox, currentColor for theming.
 */
...
export const IconBookOpen = (p) => (
  <svg {...base} width={p.size || 24} height={p.size || 24} className={p.className}>
...
export const IconDiscord = (p) => (
  <svg viewBox="0 0 24 24" width={p.size || 24} height={p.size || 24} className={p.className} aria-hidden="true">
