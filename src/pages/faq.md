...
Click any question to read the answer. If yours isn't covered here, ask on [Discord](https://discord.gg/ChNPHV2PPS) or open a [GitHub Discussion](https://github.com/MasakhaneHubToolingProject/playbook/discussions).
...
The full step-by-step guide — including frontmatter conventions, sidebar configuration, math/admonition syntax, and image handling — is in the [contribution guide in the README](https://github.com/MasakhaneHubToolingProject/playbook/blob/main/README.md#how-to-contribute-a-chapter).
...
- **5 minutes** — [Star the repo on GitHub](https://github.com/MasakhaneHubToolingProject/playbook) or [join Discord](https://discord.gg/ChNPHV2PPS).
...
- **A few hours** — Write a [blog post case study](https://github.com/MasakhaneHubToolingProject/playbook/blob/main/README.md#how-to-write-a-blog-post) about a real-world dataset project.
...
- **Bug in a chapter** (typo, broken link, wrong information): open a [new issue](https://github.com/MasakhaneHubToolingProject/playbook/issues/new) with the URL of the page and what's wrong, or click the "Edit this page" link at the bottom of the chapter and submit a fix directly.
...
- **Open-ended question or discussion**: prefer [GitHub Discussions](https://github.com/MasakhaneHubToolingProject/playbook/discussions) over an issue.
...
Still have a question? [Ask on Discord](https://discord.gg/ChNPHV2PPS) or [open a discussion](https://github.com/MasakhaneHubToolingProject/playbook/discussions).
