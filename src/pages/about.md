...
- [**Masakhane**](https://www.masakhane.io/) — pan-African NLP community
- [**EthioNLP**](https://ethionlp.github.io/) — Ethiopian NLP research and language coverage
- [**HausaNLP**](https://hausanlp.org/) — Hausa NLP research and bot-based collection
- [**Lanfrica**](https://lanfrica.com/) — discoverability and knowledge sharing
- [**Black in AI**](https://blackinai.github.io/) — outreach and community amplification
- [**Zindi Africa**](https://zindi.africa/) — competition-driven, incentivised annotation
...
- 🗣️ **GitHub Discussions** — [github.com/MasakhaneHubToolingProject/playbook/discussions](https://github.com/MasakhaneHubToolingProject/playbook/discussions)
- 🐛 **Bugs / feature requests** — [GitHub Issues](https://github.com/MasakhaneHubToolingProject/playbook/issues)
...
- **Write a chapter** — fill a gap in the Playbook. See [How to contribute a chapter](https://github.com/MasakhaneHubToolingProject/playbook/blob/main/README.md#how-to-contribute-a-chapter).
...
If you reference the Playbook in research, teaching, or a project, please cite it. See the [citation page](/cite) for BibTeX, APA, MLA, Chicago, and the machine-readable [`CITATION.cff`](https://github.com/MasakhaneHubToolingProject/playbook/blob/main/CITATION.cff).

## Code of conduct

We follow the [Contributor Covenant](https://www.contributor-covenant.org/). Be respectful — especially across language and cultural boundaries — and assume good faith. That's the whole point of the Playbook.
