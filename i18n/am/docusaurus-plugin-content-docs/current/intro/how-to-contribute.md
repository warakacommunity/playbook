...
2. Click **Suggest an edit** (or open the online editor (link removed) directly).
...
For the full style rules and deeper repository details, see [CONTRIBUTING.md](https://github.com/warakacommunity/playbook/blob/main/CONTRIBUTING.md).
