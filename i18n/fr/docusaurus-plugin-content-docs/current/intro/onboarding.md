...
|------|---------------------------|
| Annotator | [Training and Guidelines](../annotation-design/training_guidlines.md), then the relevant [modality chapter](../modality-specific-task/text-data.md) |
| Voice recorder | [Speech Data](../modality-specific-task/speech-data.md) |
| Reviewer / quality checker | [Data Quality Assurance and Validation](../data-quality/index.md) |
| Coordinator | [Cost and Resource Planning](../data-collection/cost-resource-planning.md) → [Annotation Design](../annotation-design/annotation-task-design.md) |
| Linguist | [Annotation Design](../annotation-design/annotation-task-design.md) → [Inclusive and Bias-Aware Design](../annotation-design/inclusive-bias-aware.md) |
| Dataset release lead | [Documentation and Governance](../documentation/documentation.md) → [Dataset Lifecycle](../dataset-lifecycle/release.md) |
...
- [ ] Offline copy of materials for contributors without reliable internet (see [Inclusive Access](./inclusive-access))
