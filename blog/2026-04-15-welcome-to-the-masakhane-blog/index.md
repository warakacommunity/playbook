...
Posts live in the `blog/` folder of the [AfriPlaybook repo](https://github.com/MasakhaneHubToolingProject/playbook). Each post is a markdown file (or a folder containing `index.md` if you have images). The frontmatter looks like this:
