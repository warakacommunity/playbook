...
This page covers one published example. If you've run a multimodal or cross-lingual collection effort — successful or not — [write it up](https://github.com/MasakhaneHubToolingProject/playbook/blob/main/README.md#ways-to-contribute) as an additional case study. What went wrong is often more useful to the next person than what went right.
:::
