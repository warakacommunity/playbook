...
The redesigned Phase 5 ships as **[Step 1 of Before You Start](../before-you-start/index.md#step-1-search-for-prior-work)**, which names a few places to start searching (Lanfrica, Hugging Face, the AfricaNLP workshop proceedings, Google Scholar, and arXiv) and teaches search patterns that find current African-language datasets. It does not list datasets; the sources list themselves.
