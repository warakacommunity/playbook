...
- **[Dataset search log template](./search-log.md)**: a fill-in log of where you searched for existing datasets, how each one scored against the Before You Start checklist, and what you decided. Use it before you plan a new dataset.
