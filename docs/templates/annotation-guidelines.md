...
Motivated by [Chapter 3 — Annotation Design](../3_annotation-design/) and by every corpus retrospective in the [Case Studies](../case-studies/index.md) chapter that names annotation-guideline drift as a source of quality problems.
