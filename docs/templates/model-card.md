...
- **Deployment risks:** [Specific to the task. For hate-speech classifiers, deployment-as-automated-moderation risk (see the [hate-speech page](../before-you-start/hate-speech.md)). For TTS, voice-cloning risk (see the [TTS page](../before-you-start/tts.md#voice-consent-and-voice-cloning-risks)). For classifiers deployed against marginalised users, false-positive disparity.]
