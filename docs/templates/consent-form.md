...
[PROJECT NAME] is a project run by [PROJECT ORGANISATION] to [ONE-SENTENCE PLAIN-LANGUAGE PURPOSE, NOT "TO ADVANCE NLP" BUT SOMETHING LIKE "TO BUILD A TEXT SYSTEM THAT CAN READ [LANGUAGE] SO PEOPLE CAN USE PHONES IN [LANGUAGE]"].
...
**Independent witness** (required for oral consent, recommended for written; see [Section B](#section-b-oral-consent-protocol)): ___________________
