...
- **[SLR (Open Speech and Language Resources)](https://openslr.org/)**: the umbrella project hosting many low-resource speech datasets, including several African languages. Coverage is idiosyncratic and quality varies, so read each dataset's card before use. Notable entries: SLR100 (Yoruba), SLR86 (Kiswahili), and various regional-language collections.
