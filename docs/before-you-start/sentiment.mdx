      ...
      next: {
        ...
        options: [
          ...
          },
          {
            ...
            result: <>Read the <a href="/long-tail-language">long-tail language onboarding</a> chapter first. Then the <a href="/annotation-design/annotation-task-design">Annotation Design</a> and <a href="/data-quality">Data Quality</a> chapters. Start with a small (<strong>2000–5000 example</strong>) pilot corpus following AfriSenti's annotation guidelines.</>,
          },
        ],
      },
    },
...
└── No, your language is not covered.
    ...
    └── Genuinely uncovered → Read the [long-tail language onboarding](../long-tail-language/index.md)
        chapter first. Then the Annotation Design and Data
        Quality chapters. Start with a small (2000-5000 example)
