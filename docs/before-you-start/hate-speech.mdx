      ...
      next: {
        ...
        options: [
          ...
          },
          {
            ...
            result: <>Read the <a href="/long-tail-language">long-tail language onboarding</a> chapter and the <a href="/annotation-design/annotation-task-design">Annotation Design</a> and <a href="/data-quality">Data Quality</a> chapters BEFORE writing guidelines. Involve the affected communities in label design from Step 0. <strong>Do not start this project without a psychologist or community-mental-health support commitment for annotators.</strong></>,
          },
        ],
      },
    },
...
└── No published corpus for your language.
    ...
    └── Genuinely uncovered → Read the [long-tail language
        ...
        the Annotation Design and Data Quality chapters
...
- **Cross-lingual transfer is unusually weak.** Cross-lingual sentiment transfer is already weak (see the [sentiment page](./sentiment.mdx)); for hate speech the gap is larger because the harm categories, in-group codewords, and cultural triggers do not transfer at all. Treat transferred hate-speech models as pilot signal, not deployment-ready.
