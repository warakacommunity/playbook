...
- **KaiOS and feature phones**: input methods are very limited; the practical answer for these users is voice input (see [ASR chapter](../asr/index.md)) or transliterated Latin input.
