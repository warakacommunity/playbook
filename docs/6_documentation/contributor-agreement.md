...
Pay fairly and on time, and make attribution real. A contributor agreement is also a statement of respect for the people building the data (see [Project Management](../project-management/index.md) and [Data Governance](../data-governance/index.md)).
