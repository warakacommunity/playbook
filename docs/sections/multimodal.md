...
Datasets that combine modalities, and data produced with the help of large models. These
tasks share the challenge of **aligning and jointly labelling** more than one signal.
