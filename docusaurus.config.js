...
const config = {
  ...
  //   2. Preview    — https://masakhanehubtoolingproject.github.io/playbook/
  //                   (GH Pages on MasakhaneHubToolingProject/playbook)
  ...
  // MasakhaneHubToolingProject/playbook. Production (playbook.waraka.ai)
  ...
  plugins: [
    ...
    function contributorsPlugin() {
      ...
      return {
        ...
        async loadContent() {
          const url =
            "https://api.github.com/repos/MasakhaneHubToolingProject/playbook/contributors?per_page=30";
          try {
      ...
      navbar: {
        ...
        items: [
          ...
          },
          {
            ...
            position: "right",
            value:
              '<a class="navbar-gh-stars" href="https://github.com/MasakhaneHubToolingProject/playbook" target="_blank" rel="noopener noreferrer" aria-label="Star on GitHub">' +
            ...
            items: [
              ...
              // the official Masakhane Playbook accounts are confirmed.
              {
                html: `<div class="footer-socials">
                  ...
                  <a href="https://github.com/MasakhaneHubToolingProject/playbook" target="_blank" rel="noreferrer noopener" class="footer-social-icon" aria-label="GitHub">
