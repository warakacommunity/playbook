...
- **Belay et al. (2025)** — *The Rise of AfricaNLP* — 2.2K papers, 4.9K authors, 7.8K annotated contribution sentences (2005–2025, per the abstract); 21 papers in 2006 → 287 in 2024; contributions 53% methods / 21% datasets; AfricaNLPContributions dataset (~7.8K annotated sentences) + research-explorer tool. `belay-2025`. **Use in:** Introduction (data-vs-methods gap), all chapter intros.
